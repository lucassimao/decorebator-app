...
export type ResolversTypes = {
  ...
  Quizz: ResolverTypeWrapper<Omit<Quizz, 'options'> & { options: Array<Maybe<ResolversTypes['Option']>> }>;
...
export type ResolversParentTypes = {
  ...
  Quizz: Omit<Quizz, 'options'> & { options: Array<Maybe<ResolversParentTypes['Option']>> };
  Int: Scalars['Int'];
  Query: {};
  Mutation: {};
...
export type LemmaResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Lemma'] = ResolversParentTypes['Lemma']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  lexicalCategory?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SentenceResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Sentence'] = ResolversParentTypes['Sentence']> = {
  text?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  href?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OptionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Option'] = ResolversParentTypes['Option']> = {
  __resolveType: TypeResolveFn<'Lemma' | 'Sentence', ParentType, ContextType>;
};

export type QuizzResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Quizz'] = ResolversParentTypes['Quizz']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  audioFile?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  nextQuizz?: Resolver<ResolversTypes['Quizz'], ParentType, ContextType, RequireFields<QueryNextQuizzArgs, never>>;
};

export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  saveQuizzGuess?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationSaveQuizzGuessArgs, 'quizzId' | 'success'>>;
};
