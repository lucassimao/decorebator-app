...
public class WordlistsTest {
    ...
    private static final String WORDLIST_RESOURCE_REGEX = "/wordlists\\/\\d$";
    ...
    public void registeredUserShouldBeAbleToCreateWordlistWithWords() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(3))
            .body("collect{it.name}",hasItems("word","straightforward","tight"));
    ...
    public void shouldFilterOutEmptyAndWordsOnlyWithNumbers() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(1))
            .body("collect{it.name}",hasItems("acceptable1"));
    ...
    public void shouldFilterOutUnwantedChars() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(3))
            .body("collect{it.name}",hasItems("out of the blue","123too456","xpto"));
    ...
    public void userShouldBeAbleToCreateWordlistsOnlyWithBrandNewWords() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(2))
            .body("collect{it.name}",hasItems("single","ballpark"));        
