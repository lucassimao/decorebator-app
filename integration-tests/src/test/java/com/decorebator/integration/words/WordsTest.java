...
public class WordsTest {
    ...
    public void setup() {
        ...
        assertThat(_1stWordId, notNullValue());        
    ...
    public void shouldbeAbleToReadWordsWordlistsInSortedOrder() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(3))   
            .body("collect{it.name}",hasItems("behind the ball 8","flake", "scrambled"));      
    }
    ...
    public void shoudBeAbleToAddANewWord() {
        ...
        .then()
            .statusCode(200)
            .body("size()",is(4))   
            .body("collect{it.name}",hasItems("behind the ball 8","flake","scrambled","thing"));    
